class writer {
    constructor(lang = 'en', iframeId = 'writer-js', boxId = 'editor-box', defaultValue = '', style = '') {
        ...
        // lang setting
        this.lang = lang
        this.fa_keywords = { title: 'Ø¹Ù†ÙˆØ§Ù†', size: 'Ø§Ù†Ø¯Ø§Ø²Ù‡Ù” Ù…ØªÙ†', default: 'Ù¾ÛŒØ´ ÙØ±Ø¶', type: 'Ù†ÙˆØ¹ Ù…ØªÙ†', quotation: 'Ù†Ù‚Ù„ Ù‚ÙˆÙ„' };
    ...
    createItemBar(name, documenti, content, type='span', value=null){
        if(type == 'span'){
            ...
            barItem.addEventListener('click', function(){
                if(value == 'prompt'){
                    documenti.execCommand(name, true, prompt('Ù¾ÛŒÙˆÙ†Ø¯ Ø±Ø§ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯:','https:\/\/'));
                }else{
