<script src="<?php echo e(asset('public/js/site.core.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/perfect-scrollbar.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/plugins/main.min.js')); ?>"></script>

<script src="<?php echo e(asset ('public/assets/js/plugins/apexcharts.min.js')); ?>"></script>
<script src="<?php echo e(asset ('public/js/plugins/sweetalert2.all.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/js/letter.avatar.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/jquery.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/plugins/bootstrap-switch-button.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/js/html2pdf.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/libs/bootstrap-notify/bootstrap-notify.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/datepicker-full.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/plugins/dropzone-amd-module.min.js')); ?>"></script>
...
?>
<?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>