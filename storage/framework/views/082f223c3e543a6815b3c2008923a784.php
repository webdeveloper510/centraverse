        ...
        <div class="list-group list-group-flush sidebar-nav nav-pills nav-stacked" id="menu">
            <div class="navbar-brand-box">
                <a href="#" class="navbar-brand">
                    <img src="<?php echo e($logo.'logo-light.png'); ?>" alt="<?php echo e(config('app.name', 'The Sector Eight')); ?>"
...
<?php /**PATH C:\xampp\htdocs\the-sector-eight\resources\views/partials/admin/sidebar.blade.php ENDPATH**/ ?>