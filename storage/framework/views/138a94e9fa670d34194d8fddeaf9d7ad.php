                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="food_package_description" rows="4"
                                                    class="form-control"><?php echo e($meeting->food_description ?? ''); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            $extension = pathinfo($meeting->floor_plan, PATHINFO_EXTENSION);
                                            
                                            // Define arrays of valid extensions for each file type
                                            $imageExtensions = ['jpg', 'jpeg', 'png', 'gif', 'bmp'];
                                            $pdfExtensions = ['pdf'];
                                            $documentExtensions = ['doc', 'docx', 'txt'];
                                            $excelExtensions = ['xls', 'xlsx'];
                                            
                                            // Check which category the file belongs to based on its extension
                                            if (in_array(strtolower($extension), $imageExtensions)) {
                                                $img_url = asset('floor_images/'. $meeting->floor_plan);
                                                $img_src = $img_url;
                                            } else if (in_array(strtolower($extension), $pdfExtensions)) {
                                                $img_url = asset('floor_images/pdf-sample.png');
                                                $img_src = asset('floor_images/'. $meeting->floor_plan);
                                            } else if (in_array(strtolower($extension), $documentExtensions)) {
                                                $img_url = asset('floor_images/doc-sample.png');
                                                $img_src = asset('floor_images/'. $meeting->floor_plan);
                                            } else if (in_array(strtolower($extension), $excelExtensions)) {
                                                $img_url = asset('floor_images/excel-sheet.png');
                                                $img_src = asset('floor_images/'. $meeting->floor_plan);
                                            } 
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xm-12 col-sm-12 col-md-3 col-lg-3 col-xl-3  mt-4 need_full">
                                                    ...
                                                    <label for="image_<?php echo e($loop->index); ?>" class="form-check-label">
                                                        <img src="<?php echo e(asset('floor_images/'. $s->image)); ?>"
                                                            alt="Uploaded Image" class="Setup-img img-thumbnail floorimages zoom"
                                                            data-bs-toggle="tooltip" title="<?php echo e($s->Description); ?>">
                                                    </label>
                                                </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                
                                                <div class="col-xm-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 need_full mt-4" id="previewDiv" style="display: <?php echo e($meeting->floor_plan ? 'block' : 'none'); ?>;">
                                                    <div class="form-group position-relative">
                                                        <img id="blah" src="<?php echo e($img_url); ?>" alt="Preview" class="form-control Setup-img img-thumbnai floorimages zoom" url="<?php echo e($img_src); ?>" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <button type="button" id=""
                                                                               data-setup-id="<?php echo e($setup_plan->id); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 need_full">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <?php echo e(Form::radio('baropt', $label, isset($meeting->bar) && $meeting->bar == $label ? true : false, ['id' => $label, 'class' => 'baropt-radio'])); ?>
                                            ...
                                            <div class="col-6 need_full" id="barpacakgeoptions" style="display: none;">
                                                ...
                                                <div class="form-group" data-main-index="<?php echo e($key); ?>"
                                                    ...
                                                    <div class="form-check" data-main-index="<?php echo e($k); ?>"
                                                        ...
                                                        <?php if(isset($selectedPackages[$value['bar']]) &&
                                                        $selectedPackages[$value['bar']] == $bar): ?>
                                                        <?php $checkedif = true; ?>
                                                        <?php endif; ?>
                                                        <?php endif; ?>
                                                        <?php echo Form::checkbox('bar'.'_'.str_replace(' ', '',
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="bar_package_description" rows="4"
                                                        class="form-control"><?php echo e($meeting->bar_description ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="<?php echo e(Storage::url($fname)); ?>"
                                                                                download
                                                                                style=" position: absolute;color: #1551c9 !important">
                                                                                View Document</a>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" id=""
                                                                                data-main-value="<?php echo e($file->filename); ?>"
...
swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('meeting.removesetup',$meeting->id)); ?>",
            data: {
                "setup_id": setup_id,
                "_token": "<?php echo e(csrf_token()); ?>",
            },
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
            fetch('<?php echo e(route("meeting.removesetup",$meeting->id)); ?>', {
                    method: 'POST',
                    headers: {
