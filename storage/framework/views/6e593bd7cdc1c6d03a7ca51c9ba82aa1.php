...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('Sales Order Analytic')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Report')); ?></li>
    <li class="breadcrumb-item"><?php echo e(__('Sales Order Analytic')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="cardcard-body">
                    <div class="collapse show float-end" id="collapseExample" style="">
                        ...
                        <?php echo e(Form::open(array('route' => array('report.salesorderanalytic'),'method'=>'get'))); ?>
                        ...
                        <div class="row filter-css">
                            ...
                            <div class="col-auto">
                                <a href="<?php echo e(route('report.salesorderanalytic')); ?>" data-bs-toggle="tooltip" data-title="<?php echo e(__('Reset')); ?>" title="<?php echo e(__('Reset')); ?>" class="mx-3 btn btn-sm align-items-center text-white"><i class="ti ti-trash-off"></i></a>
                            </div>
                            </div>
                    ...
                    <div class="card-body">
                        <dl class="row">
                            <?php if(isset($report['startDateRange']) || isset($report['endDateRange'])): ?>
                                <input type="hidden" value="<?php echo e(__('Salesorder Report of').' '.$report['startDateRange'].' to '.$report['endDateRange']); ?>" id="filesname">
                            <?php else: ?>
                                <input type="hidden" value="<?php echo e(__('Salesorder Report')); ?>" id="filesname">
                            <?php endif; ?>

                            <div class="col">
                                <?php echo e(__('Report')); ?> : <h6><?php echo e(__('Salesorder Summary')); ?></h6>
                            </div>
                            <div class="col">
                        ...
                        <table class="table" id="pc-dt-export">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Quote Name')); ?></th>
                                    <th scope="col" class="sort" data-sort="name"><?php echo e(__('Account')); ?></th>
                                    <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Status')); ?></th>
                                    <th scope="col" class="sort" data-sort="name"><?php echo e(__('Date Sales Order')); ?></th>
                                </tr>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $salesorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(!empty($result['quotes']['name'])?$result['quotes']['name']:'-'); ?>
                                    ...
                                    <td>
                                        <?php if($result->status == 0): ?>
                                            <span class="badge bg-secondary p-2 px-3 rounded"><?php echo e(__(\App\Models\SalesOrder::$status[$result->status])); ?></span>
                                        <?php elseif($result->status == 1): ?>
                                            <span class="badge bg-info p-2 px-3 rounded"><?php echo e(__(\App\Models\SalesOrder::$status[$result->status])); ?></span>
                                        <?php endif; ?>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        var options = {
            ...
            series: [{
                name: 'Salesorder',
                data: <?php echo json_encode($salesorderTotal); ?>,
            }],
            xaxis: {
                categories: <?php echo json_encode($monthList); ?>,
                title: {
                            text: '<?php echo e(__('Salesorder')); ?>'
                        },
            },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\centraverse\resources\views/report/salesorderanalytic.blade.php ENDPATH**/ ?>