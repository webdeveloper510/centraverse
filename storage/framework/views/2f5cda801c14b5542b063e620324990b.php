                                                ...
                                                <ul class="nav nav-tabs tabActive" style="border-bottom:none;">
                                                    <?php $__currentLoopData = $function; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="badge rounded p-2 m-1 px-3 bg-primary ">
                                                            ...
                                                            <div class="action-btn  ms-2">
                                                                <a href="#!" class="mx-3 btn btn-sm  align-items-center text-white function_show_confirm" data-bs-toggle="tooltip"  data-id = "<?php echo e($key); ?>"  title='Delete' data-url="<?php echo e(route('functionpackage.setting')); ?>" data-token="<?php echo e(csrf_token()); ?>">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="menu<?php echo e($key); ?>" class="tab-pane fade <?= $key == 0 ? 'in active show' : ''; ?>">
                                                        ...
                                                        <span class="badge rounded p-2 m-1 px-3 bg-info" style="cursor:pointer">
                                                            ...
                                                            <div class="action-btn ms-2">
                                                                <a href="#!" class="mx-3 btn btn-sm  align-items-center text-white function_package_show_confirm" data-bs-toggle="tooltip" title='Delete' data-url="<?php echo e(route('functionedit.setting')); ?>" data-id = "<?php echo e($key); ?>" data-token="<?php echo e(csrf_token()); ?>">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            </div>
...
<?php $__env->startPush('script-page'); ?>
<!-- <script>
                        $('ul.tabActive > li').click(function() {
