                                ...
                                <div class="card-body newcard_body new-div">
                                    ...
                                    <div class="flex-div">
                                        ...
                                        <div class="mt10">
                                            ...
                                            <h3 class="mb-0">
                                                <?php echo e($events_revenue_generated != 0 ? '$'.number_format($events_revenue_generated +$totaldeposit ) : '--'); ?>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div style="color: #a99595;">
                                                    ...
                                                    Amount Due: <?php echo e(($event['total'] - $total - $deposit->deposits -$adjustments +$latefee == 0) ? '--' : '$'. number_format($event['total'] - $total - $deposit->deposits -$adjustments + $latefee)); ?><br>
                                                    Deposits: <?php echo e(($deposit->deposits != 0)?'$'.$deposit->deposits :'--'); ?><br>
                                                    Amount Collected : <?php echo e(($total != 0)?'$'.$total :'--'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\the-sector-eight\resources\views/home.blade.php ENDPATH**/ ?>