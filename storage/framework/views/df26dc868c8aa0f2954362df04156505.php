...
<head>
    ...
    <style>
        /*.kbw-signature { width: 80px; height: 30px;}*/
        /*#sig canvas{*/
        /*    width: 80px;*/
        /*    height: 30px;*/
...
<body>
    <div class="row">
        ...
        <span style="text-align:left;font-size:14px;margin-bottom:10px;color:black;">Proposal</span>
        <span style="text-align:left;font-size:14px;margin-bottom:10px;color:black;">Venue Rental & Banquet Event - Estimate</span>
        </div>
    </div>
    ...
    <table border="1">
        <thead>
            <tr>
                <th style="background-color:#d3ead3;font-size:13px;font-weight:300;padding:5px 10px;">Lead Date</th>
...
</html><?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/lead/signed_proposal.blade.php ENDPATH**/ ?>