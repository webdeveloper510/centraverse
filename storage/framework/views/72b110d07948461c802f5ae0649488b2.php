                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 need_full">
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox-group">
                                                <input type="checkbox" id="approveCheckbox" name="status"
                                                    value="Approve" <?php echo e($lead->status == 2 ? 'checked' : ''); ?>>
                                                <label for="approveCheckbox">Approve</label>

                                                <input type="checkbox" id="resendCheckbox" name="status" value="Resend"
                                                    <?php echo e($lead->status == 0 ? 'checked' : ''); ?>>
                                                <label for="resendCheckbox">Resend</label>

                                                <input type="checkbox" id="withdrawCheckbox" name="status"
                                                    value="Withdraw" <?php echo e($lead->status == 3 ? 'checked' : ''); ?>>
...
$(document).ready(function() {
    $("input[type='text'][name='lead_name'],input[type='text'][name='name'], input[type='text'][name='email'], select[name='type'],input[type='tel'][name='phone'],input[type='checkbox']")
        .focusout(function() {
    ...
    $("input[name='status']").focusout(validateCheckboxGroup('status'));
    });
});
