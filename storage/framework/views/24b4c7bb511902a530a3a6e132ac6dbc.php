                ...
                <div>
                  <form method="post" action="<?php echo e(route('dopay.online',urlencode(encrypt($event->id)))); ?>">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-6">
                        <label>Amount</label>
                        <input type="number" name="amount" class="form-control" value="<?php echo e(isset($balance) ? $balance : ($event->total - $total)); ?>">
                      </div>
</div>
                    <div class="row form-group">
                      <div class=" col-md-6">
...
<?php /**PATH /home/crmcentraverse/public_html/resources/views/payments/pay.blade.php ENDPATH**/ ?>