...
<body>
    <!-- <div class="row">
        <div class="col-md-12 "> -->
            <div class="img-section">
                <img class="logo-img" src="<?php echo e(Storage::url('uploads/logo/logo-light.png')); ?>" style="width:40%;"><br>
            <!-- </div>
            <div class="img-section"> -->
    ...
    <div class="row">
        <div class="col-md-12" style="text-align: center;">
            <h5 style="text-align: center;">The Bond 1786 - Agreement</h5>
           <span style="text-align: center;"><b>Venue Rental & Banquet Event</b></span> 
        </div>
    </div>
    <div class="row mt-3">
        <!-- <div class="col-md-6"> -->
            <dl>
                <span><b><?php echo e(__('Name')); ?></b>: <?php echo e($meeting->name); ?></span><br>
                <span><b><?php echo e(__('Phone & Email')); ?></b>: <?php echo e($meeting->phone); ?> , <?php echo e($meeting->email); ?></span><br>
                <span><b><?php echo e(__('Address')); ?></b>: <?php echo e($meeting->lead_address ??'--'); ?></span><br>
                <span><b><?php echo e(__('Event Date')); ?></b>:<?php echo e(\Carbon\Carbon::parse($meeting->start_date)->format('d M, Y')); ?></span>
            ...
            <table class="table table-bordered" style="width:100%">
                ...
                <tbody>
                    <tr style="text-align:center">
                        ...
                        <td><?php echo e($meeting->rooms ??'--'); ?></td>
    ...
    <!-- <div class="row">
        <div class="col-md-12"> -->
            <p style="font-size:x-small;">This contract defines the terms and conditions under which Lotus Estate, LLC dba The Bond 1786,
                (hereinafter referred to as The Bond or The
                Bond 1786), and <b><?php echo e($meeting['name']); ?></b>(hereafter referred to as the Customer) agree to the
                Customer’s use of The Bond 1786 facilities on <b><?php echo e($startdate); ?></b>
                (reception/event date). This contract constitutes the entire agreement between the parties and becomes
                binding upon the signature of
                both parties. The contract may not be amended or changed unless executed in writing and signed by The
                Bond 1786 and the Customer.
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
           <!-- <b> Venue :</b>  <span><?php echo e($meeting['venue_selection']); ?></span>
            <p style="font-size:x-small;">
                The venue/s described above has been reserved for you for the date and time stipulated. Please note that
                the hours assigned to your event include all set-up and
                all clean-up, including the set-up and clean-up of all subcontractors that you may utilize. It is
                understood you will adhere to and follow the terms of this Agreement,
                and you will be responsible for any damage to the premises and site, including the behavior of your
            ...
            <p style="font-size:x-small;">
                ...
                date/s requested, The Bond 1786 requires this contract be signed by Customer and an <b> initial payment
                    of $3,000</b> be deposited.
                The balance is due prior to the event date. Deposits and payments will be made at the time of signing of
            ...
            <table class='billing'>
                <thead>
                    <tr>
                        ...
                        <th style="text-align:left; font-size:13px;padding:5px 5px; margin-left:5px;">Event:
                            <?php echo e($meeting['type']); ?></th>
                    </tr>
                    <tr style="background-color:#063806;">
                        <th style="color:#ffffff; font-size:13px;text-align:left; padding:5px 5px; margin-left:5px;">
                            Description</th>
                        <th colspan="2" style="color:#ffffff; font-size:13px;padding:5px 5px; margin-left:5px;">
                            Additional</th>
                        <th style="color:#ffffff; font-size:13px;padding:5px 5px;margin-left: 5px;font-size:13px">Cost
                        </th>
                        <th style="color:#ffffff; font-size:13px;padding:5px 5px;margin-left: 5px;font-size:13px">
                            Quantity</th>
                        <th style="color:#ffffff; font-size:13px;padding:5px 5px;margin-left :5px;font-size:13px">Total
                            Price</th>
                        <th style="color:#ffffff; font-size:13px;padding:5px 5px;margin-left :5px;font-size:13px">Notes
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td ><?php echo e($meeting['venue_selection']); ?>

                        </td>
                    </tr>

                    <tr>
                        <td >Brunch / Lunch / Dinner Package
                        </td>
                        <td colspan="2" ></td>
                        <td >
                    ...
                    <tr>
                        <td >Tent, Tables, Chairs, AV Equipment
                        </td>
                        <td colspan="2" ></td>
                        <td >
                    ...
                    <tr>
                        <td >Welcome / Rehearsal / Special Setup
                        </td>
                        <td colspan="2" style="padding:5px 5px; margin-left:5px;font-size:13px"></td>
                        <td >$<?php echo e($billing_data['setup']['cost']); ?>

                        </td>
                        <td >
                            <?php echo e($billing_data['setup']['quantity']); ?></td>
                        <td >
                            $<?php echo e($total[] =$billing_data['setup']['cost'] * $billing_data['setup']['quantity']); ?></td>
                    ...
                    <tr>
                        ...
                        <td >
                            <?php echo e($billing_data['additional_items']['notes']); ?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" ></td>
                        <td colspan="2" > </td>
                        <td >$<?php echo e(7* array_sum($total)/100); ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2" ></td>
                        <td colspan="2" ></td>
                        <td >$<?php echo e(20 * array_sum($total)/100); ?>
                    ...
                    <tr>
                        <td style="background-color:#ffff00; padding:5px 5px; margin-left:5px;font-size:13px;">Grand
                            Total / Estimated Total</td>
                        <td colspan="2" ></td>
                        <td colspan="2" ></td>
                        <td >
                    ...
                    <tr>
                        <td style="background-color:#d7e7d7; padding:5px 5px; margin-left:5px;font-size:13px;">Deposits
                            on file</td>
                        <td colspan="2" ></td>
                        <td colspan="2"
            ...
            <p><b> FOOD AND ALCOHOLIC BEVERAGES and 3RD PARTY / ON-SITE VENDORS</b>
                ...
                Coordinator for menu selections. The Coordinator / Owner reserves the right to approve all vendors
                providing services to the event to include food,
                audio/visual, and merchandise.<br>
                It is understood and agreed that the Customer may serve beverages containing alcohol (including but not
            ...
            <ul >
                ...
                <li>Customer shall not permit any person under the age of twenty-one (21) to consume alcohol regardless
                    of whether the person is accompanied by a parent or guardian.</li>
                <li>Customer hereby agrees to use their best efforts to ensure that Alcohol will not be served to anyone
                    who is intoxicated or appears to be intoxicated.</li>
                <li>Customer hereby expressly grants to The Bond 1786, at The Bond’s sole discretion and option, to
                    instruct the security officer(s) to remove any person(s) from the Venue, if in the opinion of The
                    Bond 1786 representative in charge, the licensed
                    and bonded Bartender and/or the security officer(s) the person(s) is intoxicated, unruly or could
                    present a danger to themselves or others, and/or the Venue.</li>
                <li>Customer hereby agrees to be liable and responsible for all act(s) and actions of every kind and
                    nature for each person in attendance at Customer’s function or event.</li>
                <li>Caterers: No caterer can be used without prior approval of The Bond 1786. Each caterer approved
                ...
                <li>If Customer requests a different food service company, they must be pre-approved by The Bond 1786
                    and meet their rules and regulations.</li>
                <li>Your catering company is responsible for the set-up, break-down and clean-up of the catered site.
                    Please allow appropriate time for break-down and clean-up to meet the contracted timelines.</li>
                <li>All event trash must be disposed of in the designated areas at the conclusion of the event.</li>
                <li>ALL vendors must adhere to the terms of our guidelines, and it is the Customer’s responsibility to
                    share these guidelines with them.</li>
                <li>Usage of cooking equipment such as fryers are allowed, with proper safety precautions, DOH
                    certifications and requirements fully satisfied. The areas these can be used should be pre-evaluated
                    and approved, along with the provisions for oil
                    disposal.</li>
                <li>All food brought into the Establishment must be prepared and ready for reheat with chafing dish and
                    sterno / Gas fuel.</li>
            ...
            <p><b>CANCELLATION POLICY & DATE CHANGES:</b><br><b>Small & Private Events -</b> A written cancellation request must be received by The Bond sales office
                ...
                100% of expected revenue is not refundable if cancellation is made between 1-29 days prior to event
                date. Company or individual contracting the event will be
                assessed this charge through either a deduction from the prepayment or charge credit card on file,
                whichever applies. If cash payment, you will be invoiced for
                any cancellation fees. Events that are booked within the 29-day period cannot be cancelled and are
                non-refundable, unless agreed upon and approved during the
                booking of the Event.</p>

           
            <p ><b> Large Events & Weddings -</b>
                ...
                deposits, and fees that are non-refundable, and non-transferable are the sole responsibility of
                Customer. The Customer further understands that last minute changes can impact the quality of the event,
                and that The Bond 1786 is not responsible for these compromises in quality.

                2. Cancellation: In the event customer cancels the event, customer shall notify The Bond 1786
            ...
            <ul >
                ...
                <li>In the event customer cancels the event less than one year but not more than six months prior to the
                    event, Customer shall forfeit to The Bond 1786 as liquidated damages the entire deposit. </li>
                <li> In the event Customer cancels the event less than six (6) months but more than three (3) months
                    prior to the event, Customer shall forfeit to The Bond 1786 as liquidated damages fifty percent (50
            ...
            <p > <b>GUARANTEE NUMBER OF GUESTS: </b>The (GTD) guaranteed count will be the assumed as the minimum billable count, however the final
            ...
            <p ><b>SET-UP & EVENT SET-UP LIMITATIONS:</b>Any space / room set up changes made on the day of the event will be charged a $500 fee. Additional time
                required above
            ...
            <ul >
                ...
                <li>Rental items must be scheduled for pick-up no later than within 24 hours of the conclusion of the
                    Event.</li>
            ...
            <p ><b> FINAL PAYMENT & PAYMENT POLICY:</b>100% of expected / outstanding balance payment is due 14 days prior to event date. The Establishment
                ...
                please send payment to: The Bond 1786, (3, Hudson Street, Warrensburg, NY 12885). Rooms must be paid for
                before entry is granted unless alternative payment arrangements have been
                pre-established for event payment. </p>

           
            <p > <b> DAMAGES:</b>The individual signing this agreement will be responsible for damage to or loss of revenue by the
                ...
                applied towards the total bills of the organized event, however in case of settlement of damages, the
            ...
            <p ><b>COMPLIANCE WITH LAWS:</b>You will comply with all applicable local and national laws, codes, regulations, ordinances, and rules
            ...
            <p > <b> INDEMNIFICATION:</b>To the extent permitted by law, you agree to protect, indemnify, defend and hold harmless the
                ...
                and costs including reasonable attorneys' fees arising out of or connected with the provision of goods
                and services and your group's use of Establishment's premises hereunder and your
                provision of services except to the extent that such claims arise out of the negligence or willful
                misconduct of the Establishment, or its employees or agents acting within the scope
                of their authority. You further agree to obtain and keep in force General Liability Insurance covering
                your contractual obligations hereunder with limits of not less than $1,000,000 per
                occurrence and provide the Establishment with proof of insurance with Establishment named as additional
            ...
            <p ><b> RESPONSIBILITY AND SECURITY</b>
                ...
                Customer(s), his or her guests, invitees, employees, or other agents under the Customer(s)
                control. Further, The Bond 1786 shall not be liable for any loss, damage or injury of any kind or
                character to any person or property caused by or arising from an act or omission of the
                Customer(s), or any of his or her guests, invitees, employees or other agents from any accident or
                casualty occasioned by the failure of the Customer(s) to maintain the premises in a
                safe condition or arising from any other cause, The Customer(s), as a material part of the consideration
                of this agreement, hereby waives on its behalf all claims and demands against
                The Bond 1786 for any such loss, damage, or injury of claims and demands against The Bond 1786 for any
                such loss, damage, or injury of the Customer(s), and hereby agrees to indemnify
                and hold The Bond 1786 free and harmless from all liability of any such loss, damage or injury to his or
                her persons, and from all costs and expenses arising there from, including but
                not limited to attorney fees. </p>

            
            <p ><b>EXCUSE OF PERFORMANCE (Force Majeure) </b>The performance of this agreement by The Bond 1786 is subject to acts of God, war, government regulations
                ...
                beyond the control of The Bond. Should the event be cancelled through a Force Majeure event, all fees
            ...
            <p ><b>SEVERABILITY</b>If any provisions of this Agreement shall be held to be invalid or unenforceable for any reason, the
            ...
            <p ><b> INSURANCE</b>The Bond 1786 shall carry liability and other insurance in such dollar amount as deemed necessary by The
                ...
                insurance in the amount of no less than One Million Dollars ($1,000,000) to protect itself against any
                claims arising from any officially scheduled activities during the
                event/program period(s); and to indemnify The Bond 1786 which shall be named as an additional insured
                for the duration of this Contract. </p>



            
            <p > <b>CONDITIONS of USE</b>Renter’s activities during the Rental Period must be compatible with use of the building/grounds and
                ...
                buildings. The Rental Space must be cleaned and returned in a condition at the end of an event to a
            ...
            <p><b>RESERVATION OF RIGHTS</b>The Bond 1786 reserves the right to cancel agreements for non-payment or for non-compliance with any of
            ...
            <p ><b>JURISDICTION & ATTORNEY’S FEES</b>The Parties agree that this Agreement will be governed by the laws of the County of Warren in the State
            ...
            <p ><b>RULES AND CONTIONS FOR USAGE</b><br><b> CANDLES:</b>The use of any type of flame is prohibited in all buildings and throughout the site. The new “flameless
                candles” which are battery operated are permitted
                for use. </p>

            
            <p > <b>CHILDREN:</b>There have been times we have had guests at the complex whose children were not properly supervised.
            ...
            <p > <b> CONTACT PERSON:</b>You must designate one individual as your Contact Person. This must not be someone heavily involved in
            ...
            <p ><b> DELIVERIES / DELIVERY TRUCKS:</b>There is a size limit to the height and length of vehicles entering the complex due to the damage
            ...
            <p ><b> DECORATIONS:</b>Only pushpins and drafting tape may be used to affix decorations and/or signs. Any other decorations,
                ...
                following the departure of the last guest unless special arrangements have been made between the
                Customer(s) and the venue.
                ALL DECORATIONS MUST BE APPROVED BY The Bond 1786. The Customer is responsible for all damages to The
            ...
            <p > <b> EVENT ENDING TIME:</b>All events must end by 11:00 PM to comply with Township/County sound ordinances and to allow for
                clean-up and closure of the site by 1:00 AM. </p>

            
            <p ><b>GARBAGE DISPOSAL:</b>Trash disposal, other than the garbage disposal of items generated by the caterer, is your
                ...
                have been dropped or blown around. This trash may be placed into The Bond 1786 dumpsters. Customer shall
                be responsible for returning the Venue (and site if applicable) to the
                condition in which it was provided to them. All property belonging to Customer, Customer’s invitees,
                guests, agents, and sub-contractors, shall be removed by the end of the
                rental period. All property remaining on the premises beyond the end of the rental agreement will be
                removed by The Bond 1786 at The Customers cost. Should the Customer
                need special consideration for the removal of property beyond the rental period, this can be arranged
            ...
            <p ><b>GUESTS:</b>Please keep in mind when inviting Guests to your event, that you are inviting them to our home. We will
                expect visitors to conduct themselves in a mature,
                responsible, and respectful manner. </p>

           
            <p > <b> HAIR & MAKE-UP</b>The Customer may provide their own Hair and Make-up staff. That staff will be provided an adequate space
            ...
            <p ><b>HANDICAP ACCOMMODTIONS:</b>We provide level-designated parking, ramped walkways throughout the property along with suitable restroom
            ...
            <p ><b>MUSIC AND ENTERTAINMENT: </b>Although music (both live and recorded) is permitted, the music must be
            ...
            <p ><b> PARKING:</b>Parking is available at the designated areas on the East side of the complex (gravel and
            ...
            <p ><b> PETS:</b>Sorry, absolutely no pets allowed. However, a family pet involved in an event will be
            considered.</p>
            ...
            <p ><b>RENTAL SPACE CHANGES: </b>Any contents or furniture movement must be pre-approved by The Bond. It is
            ...
            <p > <b>SIGNAGE:</b>You may post your group’s sign or hang balloons at the front entrance on Hudson Street,
            ...
            <p ><b> CATERING:</b> The catering service areas in each of the venues are not intended to be used as a kitchen
            for meal preparation.</p>

           
            <p ><b> WEATHER:</b> The weather is usually suitable for outside events from May 15 until October 15. Since
            ...
            <p ><b>WEDDING TENT / ARBOR: </b>The Gazebo and Arbors may be used as wedding sites and for pictures (Chairs
            ...
            <p><b>WEDDING CEREMONIES:</b> Wedding ceremonies may be held in the Reception Venue for no additional charge.
            Additional fees may apply for reset of room from ceremony to reception. Customer is responsible for
            providing ceremony coordinator, officiate, ceremony music and sound system.</p>

             <p ><b>WEDDING REHEARSAL:</b>In order to not conflict with other venue rentals, rehearsals are planned for
            ...
            <p ><b>LOGISTICAL PLANS: </b>The Bond 1786 planning team must review and approve all proposed logistical plans
            for the use of the premises a minimum of thirty (30) days prior to an event.</p>
            
<p><b>EVENTS & WEDDING POLICY AND GUIDELINES AGREEMENT </b>
 ...
 Please note that all prices are subject to 20% Service Charge and NYS 7.0% Sales Tax
            ...
            <div class="main-div">
                ...
                <div class="col-md-6" style="float:right;width:50%">
                    ...
                    <img src="<?php echo e(@$sign); ?>" style="width:40%; border-bottom:1px solid black;margin-top:10%">
                </div>

            </div>
</body>

</html><?php /**PATH C:\xampp\htdocs\centraverse\resources\views/meeting/agreement/view.blade.php ENDPATH**/ ?>