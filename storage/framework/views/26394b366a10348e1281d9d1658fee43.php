...
<body>
    ...
    <div class="details">
        <dl>
            <span><b>Name:</b> <?php echo e($meeting->name); ?></span>
            <span><b>Phone & Email:</b> <?php echo e($meeting->phone); ?> , <?php echo e($meeting->email); ?></span>
            <span><b>Address:</b> <?php echo e($meeting->lead_address ?? '--'); ?></span>
            <span><b>Event Date:</b> <?php echo e(\Carbon\Carbon::parse($meeting->start_date)->format('d M, Y')); ?></span>
        </dl>
    </div>
    ...
    <table class="table" style="    table-layout: fixed;">
        ...
        <tbody>
            <tr>
                <td><?php echo e(\Carbon\Carbon::parse($meeting->start_date)->format('d M, Y')); ?></td>
                <td>
    ...
    <!-- <div class="details">
        <p>
            ...
            <b><?php echo e($startdate); ?></b> (reception/event date). This contract constitutes the entire agreement between the
