<h6>Billing Summary -Estimate</h6>
                <table>
                    ...
                    <tbody>    
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($event['guest_count']); ?></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($event['guest_count']/2); ?></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($event['bar']); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($event['rooms']); ?></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                        </tr>
                        <tr>
                ...
                </table><?php /**PATH /home/crmcentraverse/public_html/centraverse/resources/views/billing/estimateview.blade.php ENDPATH**/ ?>