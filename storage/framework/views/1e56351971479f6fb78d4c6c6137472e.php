...
<body>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold;">QUOTE</h3>
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">
                                            <?php echo e(\App\Models\Utility::quoteNumberFormat($settings, $quote->quote)); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">
                                            <?php echo e(\App\Models\Utility::dateFormat($settings, $quote->issue_date)); ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
            ...
            <table class="add-border invoice-summary" style="margin-top: 30px;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->totalRate)); ?></td>
                        <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->totalTaxPrice)); ?></td>
                        <?php if($quote->discount_apply == 1): ?>
                            <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->totalDiscount)); ?></td>
                        <?php else: ?>
                            <td>-</td>
                        <?php endif; ?>
                        <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->getSubTotal())); ?></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                            ...
                            <table class="total-table">
                                <?php if($quote->discount_apply == 1): ?>
                                    <?php if($quote->getTotalDiscount()): ?>
                                        <tr>
                                            <td>Discount :</td>
                                            <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->getTotalDiscount())); ?>
                                ...
                                <tr>
                                    <td>Total:</td>
                                    <td><?php echo e(\App\Models\Utility::priceFormat($settings, $quote->getSubTotal() - $quote->getTotalDiscount() + $quote->getTotalTax())); ?>
    ...
    <?php if(!isset($preview)): ?>
        <?php echo $__env->make('quote.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\centraverse\resources\views/quote/templates/template1.blade.php ENDPATH**/ ?>