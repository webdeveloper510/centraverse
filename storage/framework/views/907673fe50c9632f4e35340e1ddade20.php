<div class="row">
    ...
    <div class="w-100 text-end pr-2">
            ...
            <div class="action-btn bg-warning ms-2">
                ...
                <button  data-bs-toggle="tooltip"title="<?php echo e(__('View Billing')); ?>" class="btn btn-sm btn-secondary btn-icon m-1">
                <i class="ti ti-eye"></i></button>
            </a>
            </div>
            <?php endif; ?>
        </div>
</div><?php /**PATH /home/crmcentraverse/public_html/centraverse/resources/views/billing/view.blade.php ENDPATH**/ ?>