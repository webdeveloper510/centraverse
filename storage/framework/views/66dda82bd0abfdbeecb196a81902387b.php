...
<body>
                ...
                <form method="POST" action="<?php echo e(route('lead.proposalresponse', urlencode(encrypt($lead->id)))); ?>" id='formdata'>
                    ...
                    <div class="row">
                        <div class="col-md-4 mt-4">
                            <div class="img-section" style="    text-align: center;">
    ...
    color: #aab0b6;
    margin-left: 75px;">Supported by The Sector Eight</span>
                        </div>
...
<?php /**PATH /home/crmcentraverse/public_html/resources/views/lead/proposal.blade.php ENDPATH**/ ?>