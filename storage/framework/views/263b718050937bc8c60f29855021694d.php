                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">    
                                                    <input type="radio" id="image_<?php echo e($loop->index); ?>" name="uploadedImage" class="form-check-input " value="<?php echo e(asset('/public/floor_images/' . basename($image))); ?>" style="display:none;"<?php echo e($meeting->floor_plan == $image ? 'checked' :''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/meeting/agreement/review_agreement.blade.php ENDPATH**/ ?>