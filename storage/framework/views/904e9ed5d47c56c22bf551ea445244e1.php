...
<div class="row">
    ...
    <?php if($type == 'salesorder'): ?>
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo Form::select('salesorder', $salesorder,$id,array('id'=>'salesorder','class' => 'form-control')); ?>
    ...
    <?php else: ?>
        <div class="col-6">
            <div class="form-group">
                ...
                <?php echo Form::select('salesorder', $salesorder, null,array('id'=>'salesorder','class' => 'form-control')); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('account',null,array('id'=>'account_name','class'=>'form-control','placeholder'=>__('Enter account')))); ?>
...
<?php /**PATH C:\xampp\htdocs\centraverse\resources\views/invoice/create.blade.php ENDPATH**/ ?>