    ...
    <div class="col-md-12">
        <dl class="row">
            ...
            <dd class="col-md-6"><span
                    class="text-md"><?php echo e($deposit = App\Models\Billing::where('event_id',$event->id)->pluck('deposits')->first()); ?></span>
            </dd>
...
</div><?php /**PATH C:\xampp\htdocs\centraverse\resources\views/billing/pay-info.blade.php ENDPATH**/ ?>