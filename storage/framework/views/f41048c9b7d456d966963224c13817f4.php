...
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>" />
    ...
    border-radius: 5px;"><b>Guest Count: <?php echo e(App\Models\Meeting::find($billing->event_id)->first()->guest_count); ?></b></h4>
                                <div class="form-group">
                                    ...
                                    <input type = "number" name = "deposits" min = '0' value="<?php echo e($billing->deposits); ?>" class= "form-control" >
                                    </div>
                            </div>
                        </div>
...
</style><?php /**PATH C:\xampp\htdocs\centraverse\resources\views/billing/edit.blade.php ENDPATH**/ ?>