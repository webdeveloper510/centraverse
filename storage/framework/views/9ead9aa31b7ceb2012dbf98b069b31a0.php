...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('public/uploads/metaevent/' . $setting['meta_image'])); ?>">
    ...
    <meta property="twitter:image" content="<?php echo e(asset('public/uploads/metaevent/' . $setting['meta_image'])); ?>">
    ...
    <?php if($setting['cust_darklayout'] == 'on'): ?>
        <?php if(isset($setting['SITE_RTL']) && $setting['SITE_RTL'] == 'on'): ?>
            <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/style-rtl.css')); ?>" id="main-style-link">
        <?php endif; ?>
    ...
    <?php if(isset($setting['SITE_RTL']) && $setting['SITE_RTL'] == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/custom-auth-rtl.css')); ?>" id="main-style-link">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/custom-auth.css')); ?>" id="main-style-link">
    <?php endif; ?>
    <?php if($setting['cust_darklayout'] == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/custom-auth-dark.css')); ?>" id="main-style-link">
    <?php endif; ?>
</head>
...
<body class="<?php echo e($color); ?>">
    <div class="custom-login">
        <div class="login-bg-img">
            <img src="<?php echo e(asset('public/assets/images/auth/'.$color.'.svg')); ?>" class="login-bg-1">
            <img src="<?php echo e(asset('public/assets/images/auth/common.svg')); ?>" class="login-bg-2">
        </div>
...
<script src="<?php echo e(asset('public/assets/js/vendor-all.js')); ?>"></script>
...
<?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/layouts/auth.blade.php ENDPATH**/ ?>