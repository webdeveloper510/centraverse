...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="action-btn bg-warning ms-2" style="float: inline-end;">
                                                        <a href="javascript:void(0);"
                                                            data-url="<?php echo e(route('user.create')); ?>" data-size="md"
                                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                                                            title="<?php echo e(__('Create Staff')); ?>"
                                                            data-title="<?php echo e(__('Create Staff Member')); ?>"
                                        ...
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="action-btn bg-warning ms-2" style="float: inline-end;">
                                                        <a href="javascript:void(0);"
                                                            data-url="<?php echo e(route('role.create')); ?>" data-size="lg"
                                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                                                            title="<?php echo e(__(' Create Role')); ?>"
                                                            ...
                                                            <td class="Permission mt-10">
                                                                <div class="badges">
                                                                    ...
                                                                    <span class="badge rounded p-2 m-1 px-3 bg-primary">
                                                                        <a href="#"
                                                                            class="text-white"><?php echo e($permission->name); ?></a>
                                                                    </span>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            </td>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="badges">
                                                ...
                                                <span class="badge rounded p-2 m-1 px-3 bg-primary"
                                                    ...
                                                    <div class="action-btn  ms-2">
                                                        <a href="#!"
                                                            class="mx-3 btn btn-sm  align-items-center text-white venue_show_confirm"
                                                            data-bs-toggle="tooltip" title='Delete'
                                                            data-url="<?php echo e(route('venueedit.setting')); ?>"
                                                            data-token="<?php echo e(csrf_token()); ?>">
                                                            <i class="ti ti-trash"></i>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="appending_div">
                                                <div class="appending_item" style="display:flex">
                                                    ...
                                                    <span class="btn btn-sm btn-danger btn-icon m-1 delete"><i
                                            ...
                                            <div class="badges">
                                                <ul class="nav nav-tabs tabActive" style="border-bottom:none;">
                                                    ...
                                                    <li class="badge rounded p-2 m-1 px-3 bg-primary ">
                                                        <a style="color: white;" data-toggle="tab" href="#menu<?php echo e($key); ?>"
                                                        ...
                                                        <div class="action-btn  ms-2">
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-bs-toggle="tooltip" data-id="<?php echo e($key); ?>"
                                                                title='Delete'
                                                                data-url="<?php echo e(route('functionpackage.setting')); ?>"
                                                                data-token="<?php echo e(csrf_token()); ?>">
                                                                <i class="ti ti-trash"></i>
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <?php $__currentLoopData = $function; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div id="menu<?php echo e($key); ?>"
                                                        class="tab-pane fade <?= $key == 0 ? 'in active show' : ''; ?>">
                                                        ...
                                                        <span class="badge rounded p-2 m-1 px-3 bg-info"
                                                            style="cursor:pointer">
                                                            <?php echo e($package); ?>
                                                            ...
                                                            <div class="action-btn ms-2">
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    data-bs-toggle="tooltip" title='Delete'
                                                                    data-url="<?php echo e(route('functionedit.setting')); ?>"
                                                                    data-id="<?php echo e($key); ?>" data-token="<?php echo e(csrf_token()); ?>">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            </div>
                                                        </span>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="appending_div_for_bar">
                                                <div class="appending_item_for_bar" style="display:flex">
                                                    <input type="text" name="barpackage[]" class="form-control"
                                                        placeholder="Enter Bar Package">
                                                    <span class="btn btn-sm btn-danger btn-icon m-1 deletebar"><i
                                                            class="fa fa-times"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="badges">
                                                <ul class="nav nav-tabs tabActive" style="border-bottom:none;">
                                                    ...
                                                    <li class="badge rounded p-2 m-1 px-3 bg-primary ">
                                                        <a style="color: white;" data-toggle="tab"
                                                            href="#barmenu<?php echo e($key); ?>"
                                                            class="<?= $key == 0 ? 'active' : ''; ?> barnmes"><?php echo e($value->bar); ?>
                                                        ...
                                                        <div class="action-btn  ms-2">
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-bs-toggle="tooltip" data-id="<?php echo e($key); ?>"
                                                                title='Delete'
                                                                data-url="<?php echo e(route('barpackage.setting')); ?>"
                                                                data-token="<?php echo e(csrf_token()); ?>">
                                                                <i class="ti ti-trash"></i>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <span class="badge rounded p-2 m-1 px-3 bg-info"
                                                            ...
                                                            <div class="action-btn ms-2">
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    data-bs-toggle="tooltip" title='Delete'
                                                                    data-url="<?php echo e(route('baredit.setting')); ?>"
                                                                    data-id="<?php echo e($key); ?>" data-token="<?php echo e(csrf_token()); ?>">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            </div>
                    ...
                    <div id="floor-plan-setting" class="card">
                        <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row mt-3">
                                    <form method="POST" action="<?php echo e(url('/floor-images')); ?>"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="radio" id="image_<?php echo e($loop->index); ?>" name="uploadedImage"
                                            class="form-check-input" value="<?php echo e(asset('floor_images/' . $s->image)); ?>">
                                        <label for="image_<?php echo e($loop->index); ?>" class="form-check-label">
                                            <img src="<?php echo e(asset('floor_images/'.$s->image)); ?>" alt="Uploaded Image"
                                                class="img-thumbnail floorimages zoom">
                                            <span class=" rounded p-2 m-1 px-3 bg-danger text-white"
                                                style="float: inline-end;"><i class="ti ti-trash "
                                                    data-image="<?php echo e($s->image); ?>" onclick="deleteImage(this)"></i></span>
                                        </label>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                    ...
                                    <div class="row cst-border">
                                            ...
                                            <table class="table table-responsive table-bordered" style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" class="form-control"
                                                            name="venue[<?php echo e(isset($venueKey) ? $venueKey : ''); ?>]"
                                                            id="venue_<?php echo e($venueKey); ?>"
                                                            value="<?php echo e(isset($billing['venue'][$venueKey]) ? $billing['venue'][$venueKey] : ''); ?>"
                                                            placeholder="<?php echo e(__($venueKey)); ?>" min="0"></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </table>
                                        </div>
                                        <div class="col-sm-6 function">
                                            <table class="table table-responsive table-bordered" style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $__currentLoopData = $functionValue->package; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageKey =>
                                                        $packageValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e(Form::label($packageValue, __($packageValue), ['class' => 'form-label'])); ?>

                                                        <input type="number" class="form-control"
                                                            name="package[<?php echo e(isset($functionValue->function)? $functionValue->function :''); ?>][<?php echo e(isset($packageValue) ? $packageValue : ''); ?>]"
                                                            id="package_<?php echo e(isset($packageKey)? $packageKey :''); ?>"
                                                            value="<?php echo e(isset($billing['package'][$functionValue->function][$packageValue]) ? $billing['package'][$functionValue->function][$packageValue] : ''); ?>"
                                                            placeholder="Enter <?php echo e(isset($packageValue) ? $packageValue :''); ?> Cost"
                                                            min="0">
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="col-sm-6 bar mt-3">
                                            <table class="table table-responsive table-bordered" style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $__currentLoopData = $barValue->barpackage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barpackageKey =>
                                                        $barpackageValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e(Form::label($barpackageValue, __($barpackageValue), ['class' => 'form-label'])); ?>

                                                        <input type="number" class="form-control"
                                                            name="barpackage[<?php echo e(isset($barValue->bar) ? $barValue->bar : ''); ?>][<?php echo e(isset($barpackageValue) ? $barpackageValue : ''); ?>]"
                                                            id="barpackage_<?php echo e(isset($barpackageKey) ? $barpackageKey : ''); ?>"
                                                            value="<?php echo e(isset($billing['barpackage'][isset($barValue->bar) ? $barValue->bar : ''][$barpackageValue]) ? $billing['barpackage'][isset($barValue->bar) ? $barValue->bar : ''][$barpackageValue] : ''); ?>"
                                                            placeholder="<?php echo e(isset($barpackageValue) ? $barpackageValue : ''); ?>"
                                                            min="0">
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="col-sm-6 equipment">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="equipment" id="" class="form-control"
                                                    value="<?php echo e(isset($billing['equipment']) ? $billing['equipment'] : ''); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="welcomesetup" id="" class="form-control"
                                                    value="<?php echo e(isset($billing['welcomesetup']) ? $billing['welcomesetup'] : ''); ?>"
                                                    placeholder="Enter Welcome Setup Cost" required>
                                            </div>
                                            <div class="form-group">
                                                <?php echo e(Form::label('rehearsalsetup', __('Rehearsel Setup'), ['class' => 'form-label'])); ?>

                                                <input type="number" name="rehearsalsetup" class="form-control"
                                                    value="<?php echo e(isset($billing['rehearsalsetup']) ? $billing['rehearsalsetup'] : ''); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="hotel_rooms" class="form-control"
                                                    value="<?php echo e(isset($billing['hotel_rooms']) ? $billing['hotel_rooms'] : ''); ?>"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::input('time', 'buffer_time', $settings['buffer_time'], ['class' =>
                                ...
                                <div class="card-body">
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <img src="<?php echo e($base64Image); ?>"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <button type="button" id="clearButton"
                                                class="btn btn-danger btn-sm mt-1">Clear Signature</button>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('campaign_type',null, ['class' => 'form-control',
                                                'required' => 'required']); ?>
                                    ...
                                    <span class="badge rounded p-2 m-1 px-3 bg-primary" style="cursor:pointer">
                                        ...
                                        <div class="action-btn  ms-2">
                                            <a href="#!"
                                                ...
                                                data-bs-toggle="tooltip" title='Delete'
                                                data-url="<?php echo e(route('settings.delete.campaign-type')); ?>"
                                                data-token="<?php echo e(csrf_token()); ?>">
                                                <i class="ti ti-trash"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div id="additional-items-container">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <?php if(isset($function) && !empty($function)): ?>
                                                <select name="additional_function" id="additional_function"
                                                    class="form-select">
                                    ...
                                    <div class="text-end">
                                        <button type="button" class="btn btn-primary" onclick="addAdditionalItem()"
                                            title="Add Additional items"><i class="fa fa-plus"></i></button>
                                        <input type="submit" value="Save" class="btn-submit btn btn-primary">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <table class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td data-td-data="<?php echo e($functionName); ?>" rowspan="<?php echo e(count($items)); ?>"
                                                        class="functionname"><?php echo e($functionName); ?></td>
                                                    <td data-td-data="<?php echo e($packageName); ?>" rowspan="<?php echo e(count($items)); ?>"
                                                        class="package"><?php echo e($packageName); ?></td>
                                                    <?php $firstItem = true; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-function="<?php echo e($functionName); ?>"
                                                        data-package="<?php echo e($packageName); ?>">
                                                        <button class="btn btn-sm edit-cost-btn bg-info"> <i
                                                                class="ti ti-edit"></i></button>
                                                        <a href="#!"
                                                            class="mx-3 btn btn-sm  align-items-center bg-info text-white additional_show_confirm"
                                                            data-bs-toggle="tooltip" title='Delete'
                                                            data-function="<?php echo e($functionName); ?>"
                                                            data-package="<?php echo e($packageName); ?>" data-item="<?php echo e($itemName); ?>"
                                                            data-url="<?php echo e(route('additionaldelete.setting')); ?>"
                                                            data-token="<?php echo e(csrf_token()); ?>">
                                                            <i class="ti ti-trash"></i>
                                                        </a>
                                                    </td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="faq justify-content-center">
                                                ...
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-4">
                                                            <div class="row pt-2">
                                                                <label class="pb-2"
                                                                    for="is_manually_enabled"><?php echo e(__('Requesting manual payment for the planned amount for the subscriptions paln.')); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-16">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse16" aria-expanded="true"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="sspay_secret_key"
                                                            class="form-label"><?php echo e(__('Secret Key')); ?></label>
                                                        <input type="text" name="sspay_secret_key" id="sspay_secret_key"
                                                            class="form-control"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-17">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse17" aria-expanded="true"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-18">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse18" aria-expanded="true"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="benefit_api_key" id="benefit_api_key"
                                                            class="form-control"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-19">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse19" aria-expanded="true"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cashfree_api_key" id="cashfree_api_key"
                                                            class="form-control"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-20">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse20" aria-expanded="true"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-21">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse21" aria-expanded="true"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="yookassa_shop_id" id="yookassa_shop_id"
                                                            class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="yookassa_secret"
                                                            class="form-label"><?php echo e(__('Secret Key')); ?></label>
                                                        <input type="text" name="yookassa_secret" id="yookassa_secret"
                                                            class="form-control"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-23">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse23" aria-expanded="true"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="midtrans_secret"
                                                            class="form-label"><?php echo e(__('Secret Key')); ?></label>
                                                        <input type="text" name="midtrans_secret" id="midtrans_secret"
                                                            class="form-control"
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header" id="heading-2-24">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse24" aria-expanded="true"
                            ...
                            <div class="col-6 text-end">
                                <div class="col switch-width">
                                    <div class="form-group ml-2 mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" data-onstyle="primary"
                                                data-toggle="switchbutton" name="recaptcha_module" id="recaptcha_module"
                                                value="yes"
                        ...
                        <div class="row mt-0">
                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                ...
                                <input class="form-control" placeholder="<?php echo e(__('Enter Google Recaptcha Key')); ?>"
                                    ...
                                    value=" <?php echo e(!isset($settings['google_recaptcha_key']) || is_null($settings['google_recaptcha_key']) ? '' : $settings['google_recaptcha_key']); ?>"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                ...
                                <input class="form-control " placeholder="<?php echo e(__('Enter Google Recaptcha Secret')); ?>"
                                    ...
                                    value=" <?php echo e(!isset($settings['google_recaptcha_secret']) || is_null($settings['google_recaptcha_secret']) ? '' : $settings['google_recaptcha_secret']); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="choose-files mt-4">
                                    <label for="meta_image">
                                        ...
                                        <input style="margin-top: -40px;" type="file" class="form-control file"
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch custom-switch-v1" id="cookie_log">
                                <input type="checkbox" name="cookie_logging"
                                    class="form-check-input tem input-primary cookie_setting str" id="cookie_logging"
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch custom-switch-v1 ">
                                <input type="checkbox" name="necessary_cookies"
                                    class="form-check-input tem input-primary str" id="necessary_cookies" checked
        ...
        $.each(functionarr, function(index, function_val) {
            if (index == value) {
                ...
                $.each(packagevalue, function(index, val) {
                    var inputField = '<div class = "form-group"><label for="package_' + index +
                        '">' + val + ' Cost:</label>';
