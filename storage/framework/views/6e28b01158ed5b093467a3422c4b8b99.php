...
<link href='<?php echo e(url("public/css/editor-style.css")); ?>' rel="stylesheet">
<script src='<?php echo e(url("public/js/editor-script.js")); ?>'></script>
<script>
function myFunction() {
                                ...
                                <div class="accordion accordion-flush setting setting-accordion1" id="accordionExample">
                                    ...
                                    <div id="add-template-setting" class="accordion-item card">
                                        ...
                                        <div id="collapse50" class="accordion-collapse collapse"
                                            aria-labelledby="heading-2-15" data-bs-parent="#accordionExample">
                                            <div class="accordion-body1">
                                                <?php echo e(Form::open(['route' => 'template.setting', 'method' => 'post', 'id' => 'templateSettingForm'])); ?>
                                            ...
                                            <div class="accordion-body1">
                                                <?php echo e(Form::open(['route' => 'terms_condition.setting', 'method' => 'post', 'id' => 'termsConditionSettingForm'])); ?>
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="form-check form-switch float-end">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="twilio_meeting_create"></label>
                                                                </div>
                                                            </li>
                                                            <!-- <li class="list-group-item">
                                        ...
                                        <h2 class="accordion-header" id="heading-2-15">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                <div class="action-btn bg-warning ms-2" style="float: inline-end;">
                                                    <a href="javascript:void(0);" data-url="<?php echo e(route('user.create')); ?>"
                                    ...
                                    <div id="role-settings" class="accordion-item card">
                                        <h2 class="accordion-header" id="heading-2-15">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                <div class="action-btn bg-warning ms-2" style="float: inline-end;">
                                                    <a href="javascript:void(0);" data-url="<?php echo e(route('role.create')); ?>"
                                            ...
                                            <div class="accordion-body1">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <span
                                                                        class="btn btn-sm btn-primary btn-icon m-1 add"
                                                                        style="border-radius: 20px !important;    font-size: 12px;
                                                                                    "><i
                                                                            class="fa fa-plus "></i></span>
                                                                    <div class="appending_div">
                                                                        <div class="appending_item"
                                                                            style="display:flex">
                                                                            <input type="text" name="package[]"
                                                                                class="form-control"
                                                                                placeholder="Enter Package">
                                                                            <span
                                                                                class="btn btn-sm btn-danger btn-icon m-1 delete"><i
                                                                            ...
                                                                            <li
                                                                                ...
                                                                                <div class="action-btn  ms-2">
                                                                                    <a href="javascript:void(0);"
                                                                                        ...
                                                                                        data-token="<?php echo e(csrf_token()); ?>"
                                                                                        onclick="deleteFunction('<?php echo e($value->function); ?>' , <?php echo e($key); ?>)"
                                                                                        >
                                                                                        <i class="ti ti-trash"></i>
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <div class="action-btn ms-2">
                                                                                        <a href="javascript:void(0);"
                                                                                            ...
                                                                                            onclick="deletePackageFunction('<?php echo e($package); ?>' , <?php echo e($key); ?>)">
                                                                                            <i class="ti ti-trash"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </span>
                                                ...
                                                <div id="bar-settings" class="card">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                <?php echo e(Form::open(['route' => 'bar.setting', 'method' => 'post' , 'id' => 'barSettingForm'])); ?>

                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-group col-md-12">
                                                                    <?php echo e(Form::label('bar', __('Bar'), ['class' => 'form-label'])); ?>

                                                                    <?php echo e(Form::text('bar',null,['class' => 'form-control ', 'placeholder' => __('Enter Bar'), 'required' => 'required' , 'id' => 'bar'])); ?>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <span
                                                                        class="btn btn-sm btn-primary btn-icon m-1 addbar"
                                                                        style="border-radius: 20px !important;    font-size: 12px;
                                                                                    "><i
                                                                            class="fa fa-plus "></i></span>
                                                                    <div class="appending_div_for_bar">
                                                                        <div class="appending_item_for_bar"
                                                                            style="display:flex">
                                                                            <input type="text" name="barpackage[]"
                                                                                class="form-control"
                                                                                placeholder="Enter Bar Package">
                                                                            <span
                                                                                class="btn btn-sm btn-danger btn-icon m-1 deletebar"><i
                                                                                    class="fa fa-times"></i></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <li
                                                                                ...
                                                                                <div class="action-btn  ms-2">
                                                                                    <a href="javascript:void(0);"
                                                                                        ...
                                                                                        data-token="<?php echo e(csrf_token()); ?>"
                                                                                        onclick="deleteBar('<?php echo e($value->bar); ?>' , <?php echo e($key); ?>)"
                                                                                        >
                                                                                        <i class="ti ti-trash"></i>
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <div class="action-btn ms-2">
                                                                                        <a href="javascript:void(0);"
                                                                                            ...
                                                                                            onclick="deletePackageBar('<?php echo e($package); ?>' ,<?php echo e($key); ?> )">
                                                                                            <i class="ti ti-trash"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </span>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                <form method="POST" action="<?php echo e(url('/floor-images')); ?>"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            <label for="setup" class="form-label">Choose
                                                                                Image</label></br>
                                                                            <input type="file" name="setup"
                                                                                class="form-control" required />
                                                                        </div>
                                                                        <div class="form-group col-md-6">
                                                                            <label for="title"
                                                                                class="form-label">Title</label></br>
                                                                    ...
                                                                    <div class="text-end">
                                                                        <button type="submit"
                                                                            class="btn-submit btn btn-primary">Submit</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="row all-setup">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <label for="image_<?php echo e($loop->index); ?>"
                                                ...
                                                <div id="campaign-type" class="card">
                                                    <div class="col-md-12">
                                                        ...
                                                        <form method="POST" action="<?php echo e(route('settings.campaign-type')); ?>"
                                                            id='campaign'>
                                                            <?php echo csrf_field(); ?>
                                                            <div class="card-body">
                                                                <div class="row mt-3">
                                                                ...
                                                                <span class="badge rounded p-2 m-1 px-3 bg-primary"
                                                                    ...
                                                                    <div class="action-btn  ms-2">
                                                                        <a href="#!"
                                                                            ...
                                                                            data-token="<?php echo e(csrf_token()); ?>"
                                                                            onclick="deleteCampaign('<?php echo e($value); ?>' , this)">
                                                                            <i class="ti ti-trash"></i>
                                                                        </a>
                                                                    </div>
                                                                </span>
                                                ...
                                                <div id="additional-settings" class="card">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                <?php echo e(Form::open(['route' => 'additional.setting', 'method' => 'post' , 'id'   =>  'additionalSettingForm'])); ?>
                                                                ...
                                                                <div id="additional-items-container">
                                                                    <div class="row form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <?php if(isset($function) && !empty($function)): ?>
                                                                            <select name="additional_function"
                                                                                id="additional_function"
                                                                                class="form-select">
                                                                                <option value="0" selected disabled>
                                                                                    Select Function</option>
                                                                                <?php $__currentLoopData = $function; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($key); ?>">
                                                                                    <?php echo e($value->function); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <table class="table table-striped table-bordered"
                                                                        ...
                                                                        <tbody class="all_aditional_items">
                                                                            ...
                                                                            <tr>
                                                                                <td data-td-data="<?php echo e($functionName); ?>"
                                                                                    rowspan="<?php echo e(count($items)); ?>"
                                                                                    class="functionname">
                                                                                    <?php echo e($functionName); ?></td>
                                                                                <td data-td-data="<?php echo e($packageName); ?>"
                                                                                    rowspan="<?php echo e(count($items)); ?>"
                                                                                    class="package">
                                                                                    <?php echo e($packageName); ?></td>
                                                                                <?php $firstItem = true; ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td data-function="<?php echo e($functionName); ?>"
                                                                                    ...
                                                                                    <button
                                                                                        class="btn btn-sm edit-cost-btn bg-info">
                                                                                        <i
                                                                                    ...
                                                                                    <a href="#!"
                                                                                        ...
                                                                                        data-token="<?php echo e(csrf_token()); ?>"
                                                                                        onclick='deleteAditionalItem("<?php echo e($functionName); ?>" , "<?php echo e($packageName); ?>" , "<?php echo e($itemName); ?>")'
                                                                                        >
                                                                                        <i class="ti ti-trash"></i>
                                                                                    </a>
                                                                                </td>
                                    ...
                                    <div id="billing-setting" class="accordion-item card">
                                        ...
                                        <div id="collapse20" class="accordion-collapse collapse"
                                            aria-labelledby="heading-2-15" data-bs-parent="#accordionExample">
                                            <div class="accordion-body1">
                                                <?php echo e(Form::open(['route' => 'billing.setting', 'method' => 'post' ,'id' => 'billingSettingForm'])); ?>
                                                        ...
                                                        <table class="table table-responsive table-bordered"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="number" class="form-control"
                                                                        ...
                                                                        placeholder="<?php echo e(__($venueKey)); ?>" min="0">
                                                                </td>
                                                            </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </table>
                                    ...
                                    <div id="buffer-settings" class=" accordion-item card">
                                        ...
                                        <div id="collapse21" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body1">
                                                <div class="row">
                                                <?php echo e(Form::open(['route' => 'buffer.setting', 'method' => 'post' , 'id' => 'bufferSettingForm'])); ?>
                                                ...
                                                <div class="card-body1">
                                                    <div class="row mt-3">
                                                        <div class="col-6 need_full">
                                                            ...
                                                            <img src="<?php echo e($base64Image); ?>" id="sign_image"
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch custom-switch-v1" id="cookie_log">
                                    <input type="checkbox" name="cookie_logging"
                                        class="form-check-input tem input-primary cookie_setting str"
                                        id="cookie_logging"
                        ...
                        setup_content += `
                                            <div class="col-6">
                                                <input type="radio" id="image_${index}"
                                                    name="uploadedImage" class="form-check-input"
                                                    value="<?php echo e(asset('floor_images/')); ?>/${result.data[index].image}">
                                                <label for="image_${index}"
                                                    class="form-check-label">
                                                    <img src="<?php echo e(asset('floor_images/')); ?>/${result.data[index].image}"
                                                        alt="Uploaded Image"
                                                        class="img-thumbnail floorimages zoom">
                                                    <span
                                                        class=" rounded p-2 m-1 px-3 bg-danger text-white"
                                ...
                                if (packages.hasOwnProperty(packageName)) {
                                    ...
                                    for (const itemName in items) {
                                        if (items.hasOwnProperty(itemName)) {
                                            ...
                                            let $deleteLink = $(`<a href="#!" class="mx-3 btn btn-sm align-items-center bg-info text-white additional_show_confirms" data-bs-toggle="tooltip" title="Delete" onclick='deleteAditionalItem("${functionName}" ,"${packageName}" , "${itemName}" )' data-function="${functionName}" data-package="${packageName}" data-item="${itemName}" data-url="<?php echo e(route('additionaldelete.setting')); ?>" data-token="<?php echo e(csrf_token()); ?>"><i class="ti ti-trash"></i></a>`);
