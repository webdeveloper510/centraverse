...
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    <dt class="col-md-5"><span class="h6 text-md mb-0"><?php echo e(__('Lead Name')); ?></span></dt>
                    <dd class="col-md-5"><span class="text-md"><?php echo e(!empty($meeting->attendees_leads->leadname)?$meeting->attendees_leads->leadname:'--'); ?></span></dd>
                    ...
                    <dd class="col-md-5"><span class="text-md"><?php echo e(date('h:i A', strtotime($meeting->start_time))); ?>

</span></dd>
                    
                    <dt class="col-md-5"><span class="h6 text-md mb-0"><?php echo e(__('End Time')); ?></span></dt>
                    <dd class="col-md-5"><span class="text-md"><?php echo e(date('h:i A', strtotime($meeting->end_time))); ?></span></dd>
                    <!--  -->
                    ...
                    <dt class="col-sm-5"><span class="h6 text-sm mb-0"><?php echo e(__('Assigned Staff')); ?></span></dt>
                    <!-- <dd class="col-sm-7"><span class="text-md"><?php echo e(!empty($meeting->assign_user)?$meeting->assign_user->name:''); ?></span></dd> -->
                    <dd class="col-sm-7"><span class="text-md"><?php echo e($name); ?></span></dd>
...
<?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/meeting/view.blade.php ENDPATH**/ ?>