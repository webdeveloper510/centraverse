        ...
        custdarklayout.addEventListener("click", function() {
            if (custdarklayout.checked) {
                ...
                document
                    ...
                    .setAttribute("href", "<?php echo e(asset('public/assets/css/style-dark.css')); ?>");
                document
                ...
                document
                    .querySelector("#main-style-link")
                    .setAttribute("href", "<?php echo e(asset('public/assets/css/style.css')); ?>");
                document
                    .querySelector(".m-header > .b-brand > .logo-lg")
                    .setAttribute("src", "<?php echo e(asset('/storage/uploads/logo/logo.png')); ?>");
            }
...
<?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/layouts/admin.blade.php ENDPATH**/ ?>