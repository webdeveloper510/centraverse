...
<body>
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="img-section" style="width:20%; margin: 0 auto;display:flex;">
                                <img class="logo-img" src="<?php echo e(asset('storage/uploads/logo/logo.png')); ?>" style="width:12%; margin:30px auto;display:flex;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div id = "loader" style = "display:none">
            <img src = "<?php echo e(asset('public/assets/loader/loader.webp')); ?>"  >
        </div>
        <style>
...
</script><?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/meeting/agreement/signedagreement.blade.php ENDPATH**/ ?>