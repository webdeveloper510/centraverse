            ...
            <div class="form-group">
                ...
                <div class="scrolldiv"id="category">
                    <ul class="list-group categories">
                        ...
                        <li class="list-group-item"><?php echo e(ucfirst($campaign)); ?><input type="checkbox" name="type[]" value="<?php echo e($campaign); ?>" style="  float: right;"></li>
...
<script>
    $('.categories input[type="checkbox"]').change(function () {
        ...
        $.ajax({
            url: "<?php echo e(route('campaign_categories')); ?>",
            type: 'POST',
            data: {
                "types": checkedValues,
...
<?php /**PATH /home/crmcentraverse/public_html/centraverse/resources/views/customer/addeduserlist.blade.php ENDPATH**/ ?>