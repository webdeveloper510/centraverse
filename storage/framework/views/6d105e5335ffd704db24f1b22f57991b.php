                                    ...
                                    <div class="row mt-0">
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <input class="form-control"
                                                ...
                                                value=" <?php echo e(!isset($settings['google_recaptcha_key']) || is_null($settings['google_recaptcha_key']) ? '' : $settings['google_recaptcha_key']); ?>" id="google_recaptcha_key">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <input class="form-control "
                                                ...
                                                value=" <?php echo e(!isset($settings['google_recaptcha_secret']) || is_null($settings['google_recaptcha_secret']) ? '' : $settings['google_recaptcha_secret']); ?>" id="google_recaptcha_secret">
                                        </div>
                                        <div class="text-end">
                                            <?php echo e(Form::submit(__('Save Changes'), ['class' => 'btn-submit btn btn-primary'])); ?>
                                    ...
                                    <?php $__currentLoopData = File::files(public_path('floor_images')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-6">    
                                            ...
                                            <label for="image_<?php echo e($loop->index); ?>" class="form-check-label">
                                                <img src="<?php echo e(URL::asset('public/floor_images/'. basename($image))); ?>" alt="Uploaded Image" class="img-thumbnail floorimages zoom">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/settings/index.blade.php ENDPATH**/ ?>