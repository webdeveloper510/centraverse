...
<body>
    ...
    <div class="row" style="margin-top:10px;padding-top:10px;">
        <div class="col-md-6" style="width:50%; border:1px solid black; margin-top:10px">
            ...
            <table border="1">
                <thead>
                    <tr>
                        <th style="font-size:13px;font-weight:300;padding:10px 25px;">Start:<?php echo e(date('h:i A', strtotime($meeting['start_time']))); ?></th>
                        <th style="font-size:13px;font-weight:300;padding:0px 25px;">End: <?php echo e(date('h:i A', strtotime($meeting['end_time']))); ?> </th>
                        <th style="font-size:13px;font-weight:300;padding:10px 25px;">Function : <?php echo e($meeting['function']); ?></th>
                    </tr>
                </thead>
                </tbody>  
            </table>          
        ...
        <div class="col-md-6" style="float:right;  margin-top:-16.1rem; padding-top:0rem; border:1px solid black; width:45%;text-align:center;">
    ...
    <div class="row">
         <div class="col-md-12">
                ...
                <p><?php echo e($meeting['venue_selection']); ?></p><br><br>
                <p>
                ...
                <table border="1">
                            ...
                            <tbody>    
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $billing['classic_brunch'] * $meeting['guest_count']); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $billing['platinum_3hrs'] * ($meeting['guest_count']/2)); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($meeting['rooms']); ?></td>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $billing['hotel_rooms'] * $meeting['rooms']); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($meeting['guest_count']); ?></td>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $billing['equipment'] * $meeting['guest_count']); ?></td>
...
</html><?php /**PATH /home/crmcentraverse/public_html/centraglobe/main-file/resources/views/meeting/agreement/view.blade.php ENDPATH**/ ?>