                                ...
                                <div class="table-responsive overflow_hidden">
                                    <table id="datatable" class="table datatable align-items-center">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo e(isset($deposit->deposits)? '$'.$deposit->deposits : '--'); ?></td>
</tr>
<tr> 
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td><?php echo e(($payinfos[0]->deposits + $latefee - $adj + $collect_amount)<=0 ?'--': '$'.($payinfos[0]->deposits + $latefee - $adj + $collect_amount)); ?></td>
</tr>
                                        </tbody>
                                    </table>
                                </div>
