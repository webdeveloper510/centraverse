                ...
                <form method= "POST" action = "<?php echo e(route('meeting.signedagreementresp',urlencode(encrypt($meeting->id)))); ?>" id = 'formdata'>
                    ...
                    <div class = "row">
                        <div class = "col-md-12">
                            <table border="1" style = "width:100%">
                                <thead>
                                    <tr>
                                        <th style="background-color:#d3ead3;font-size:13px;font-weight:300;padding:5px 0px;">Event Date</th>
                                        <th style="background-color:#d3ead3;font-size:13px;font-weight:300;padding:5px 0px;">Time</th>
                                        <th style="background-color:#d3ead3;font-size:13px;font-weight:300;padding:5px 0px;">Venue</th>
                                        ...
                                        <td style="background-color:#d3ead3;font-size:13px;font-weight:300;padding:5px 0px;">Exp</td>
                                ...
                                <tbody>    
                                    <tr>
                                        <td style="font-size:13px;font-weight:300;padding:8px 0px;">Start Date: <?php echo e(\Carbon\Carbon::parse($meeting->start_date)->format('d M, Y')); ?> <br>
                                        End Date: <?php echo e(\Carbon\Carbon::parse($meeting->start_date)->format('d M, Y')); ?></td>
                    ...
                    <div class="row" style="margin-top:10px;padding-top:10px;display:flex;">
                        ...
                        <div class="col-md-6" style="border:1px solid black; width:50%;text-align:center;">
                            ...
                            <p style="text-align:center; border:1px solid black;padding:5px;font-weight:bold;">Audio Visual Requirements</p>
                            <div class="text" style="border:1px solid black;"> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <h6  class="headings">SET-UP & EVENT SET-UP LIMITATIONS:</h6> <p>Any space / room set up changes made on the day of the event will be charged a $500 fee. Additional time required above 
                                ...
                                <h6  class="headings">FINAL PAYMENT & PAYMENT POLICY:</h6><p> 100% of expected / outstanding balance payment is due 14 days prior to event date. The Establishment will terminate the contract 
                                ...
                                <h6  class="headings">DAMAGES:</h6><p> The individual signing this agreement will be responsible for damage to or loss of revenue by the Establishment due to activities of the guests under this contract, 
                                ...
                                <h6  class="headings">COMPLIANCE WITH LAWS:</h6> <p>You will comply with all applicable local and national laws, codes, regulations, ordinances, and rules with respect to your obligations under 
                                ...
                                <h6  class="headings">INDEMNIFICATION:</h6><p> To the extent permitted by law, you agree to protect, indemnify, defend and hold harmless the Establishment, Lotus Estate, LLC dba The Bond 1786 
                                ...
                                <h6  class="headings">CANDLES:</h6>  <p>The use of any type of flame is prohibited in all buildings and throughout the site.  The new “flameless candles” which are battery operated are permitted 
                                for use.  </p>
                                ...
                                <h6  class="headings">CONTACT PERSON:</h6>   <p> You must designate one individual as your Contact Person.  This must not be someone heavily involved in the activities of the day, as they will be too
                                ...
                                <h6  class="headings">DELIVERIES / DELIVERY TRUCKS:</h6>   <p>There is a size limit to the height and length of vehicles entering the complex due to the damage inflicted to our trees. 
                                ...
                                <h6  class="headings">DECORATIONS:</h6>   <p>Only pushpins and drafting tape may be used to affix decorations and/or signs.  Any other decorations, signage, electrical configurations, or
                                ...
                                <h6  class="headings">EVENT ENDING TIME:</h6> <p> All events must end by 11:00 PM to comply with Township/County sound ordinances and to allow for clean-up and closure of the site by 1:00 AM.  </p>
                
                                <h6  class="headings">GARBAGE DISPOSAL:</h6>   <p>Trash disposal, other than the garbage disposal of items generated by the caterer, is your responsibility.  Immediately following the event, 
                                ...
                                <h6  class="headings">GUESTS:</h6>   <p>Please keep in mind when inviting Guests to your event, that you are inviting them to our home.  We will expect visitors to conduct themselves in a mature, 
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/signature_pad/1.5.3/signature_pad.min.js"></script>
 ...
 <?php /**PATH /home/crmcentraverse/public_html/centraverse/resources/views/meeting/agreement/signedagreement.blade.php ENDPATH**/ ?>