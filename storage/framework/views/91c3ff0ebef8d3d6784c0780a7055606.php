...
<body>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <dl>
                <span><?php echo e(__('Name')); ?>: <?php echo e($meeting->name); ?></span>
                <span><?php echo e(__('Phone & Email')); ?>: <?php echo e($meeting->phone); ?> , <?php echo e($meeting->email); ?></span>
                <span><?php echo e(__('Address')); ?>: <?php echo e($meeting->lead_address); ?></span>
...
</html><?php /**PATH /home/crmcentraverse/public_html/resources/views/meeting/agreement/view.blade.php ENDPATH**/ ?>