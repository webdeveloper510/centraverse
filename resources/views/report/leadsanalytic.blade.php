                    ...
                    <table class="table" id="pc-dt-export">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="budget">{{ __('Converted') }}</th>
                                <th scope="col" class="sort" data-sort="budget">{{ __('Proposal Status') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{App\Models\User::where('id',$result['created_by'])->first()->name}}
                                </td>
                                <td>
                                    {{ $result['type'] }}
                                </td>
                                ...
                                <!-- <td>
                                    @if($result->lead_status == 0)
                                    <span
                                        class="badge bg-danger p-2 px-3 rounded">{{ __(\App\Models\Lead::$stat[$result->lead_status]) }}</span>
                                    @else
                                    <span
                                        class="badge bg-success p-2 px-3 rounded">{{ __(\App\Models\Lead::$stat[$result->lead_status]) }}</span>
                                    @endif
                                </td> -->
                                <td>
                                ...
                                <td>
                                @if($result['proposal_status'] == 0)
                                                    <span class="badge bg-info p-2 px-3 rounded">{{ __(\App\Models\Lead::$status[$result['proposal_status']]) }}</span>
                                                    @elseif($result['proposal_status'] == 1)
                                                    <span class="badge bg-warning p-2 px-3 rounded">{{ __(\App\Models\Lead::$status[$result['proposal_status']]) }}</span>
                                                    @elseif($result['proposal_status'] == 2)
                                                    <span class="badge bg-success p-2 px-3 rounded">{{ __(\App\Models\Lead::$status[$result['proposal_status']]) }}</span>
                                                    @elseif($result['proposal_status'] == 3)
                                                    <span class="badge bg-danger p-2 px-3 rounded">{{ __(\App\Models\Lead::$status[$result['proposal_status']]) }}</span>
                                                    @endif
                                </td>
                            </tr>
                            @endforeach
