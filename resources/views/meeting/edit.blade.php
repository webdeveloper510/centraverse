                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xm-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 need_full mt-4" id="previewDiv" style="display: {{ $meeting->floor_plan ? 'block' : 'none' }};">
                                                    <div class="form-group position-relative">
                                                        <img id="blah" src="{{$img_url }}" alt="Preview" class="form-control Setup-img img-thumbnai floorimages zoom" url="{{$img_src }}" />
