...
<body>
    ...
    <div class="details">
        <dl>
            <span><b>Name:</b> {{ $meeting->name }}</span>
            <span><b>Phone & Email:</b> {{ $meeting->phone }} , {{ $meeting->email }}</span>
            <span><b>Address:</b> {{ $meeting->lead_address ?? '--' }}</span>
            <span><b>Event Date:</b> {{ \Carbon\Carbon::parse($meeting->start_date)->format('d M, Y') }}</span>
        </dl>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>{{ \Carbon\Carbon::parse($meeting->start_date)->format('d M, Y') }}</td>
                <td>
    ...
    <div class="details">
        <p>
            ...
            (hereinafter referred to as The Bond or The Bond 1786), and <b>{{$meeting['name']}}</b>
            (hereafter referred to as the Customer) agree to the Customer’s use of The Bond 1786 facilities on
            <b>{{$startdate}}</b> (reception/event date). This contract constitutes the entire agreement between the
            parties and becomes binding upon the signature of both parties. The contract may not be amended or changed
            unless executed in writing and signed by The Bond 1786 and the Customer.
        </p>
    </div>
    ...
    <div class="details">
        ...
        <p><b>Rental Deposit and Payment Agreement</b>
    ...
    <b>Customer Comments/Notes: </b>{{isset($agreement)?$agreement->notes :'--'}}
    <div class="detailsss">
        ...
        <p><b>CANCELLATION POLICY & DATE CHANGES:</b><br><b>Small & Private Events -</b> A written cancellation request must
        ...
        <p> <b>GUARANTEE NUMBER OF GUESTS: </b>The (GTD) guaranteed count will be the assumed as the minimum billable count,
            however the final
            ...
            event, whichever is higher.<br><b>SET-UP & EVENT SET-UP LIMITATIONS:</b>Any space / room set up changes made on
        ...
        <p>
            <b> FINAL PAYMENT & PAYMENT POLICY:</b>100% of expected / outstanding balance payment is due 14 days prior to
            ...
            pre-established for event payment. <br> <b> DAMAGES:</b>The individual signing this agreement will be
            ...
            Card on file, should there be a remaining balance due to The Bond 1786.<br><b>COMPLIANCE WITH LAWS:</b>You will
            comply with all applicable local and national laws, codes, regulations, ordinances, and rules
            ...
            applicable local, state, federal regulations or laws. <br> <b> INDEMNIFICATION:</b>To the extent permitted by
            ...
            client to provide security services for the event at client cost. <br><b> RESPONSIBILITY AND SECURITY</b>
            ...
            not limited to attorney fees.<br><b>EXCUSE OF PERFORMANCE (Force Majeure) </b>The performance of this agreement
            ...
            no penalty, and there shall be no further liability between the parties.<br><b>SEVERABILITY</b>If any provisions
            ...
            shall be deemed to be written, construed, and enforced as so limited. <br><b> INSURANCE</b>The Bond 1786 shall
            ...
            for the duration of this Contract. <br> <b>CONDITIONS of USE</b>Renter’s activities during the Rental Period
            ...
            <br><b>RESERVATION OF RIGHTS</b>The Bond 1786 reserves the right to cancel agreements for non-payment or for
            ...
            <b>JURISDICTION & ATTORNEY’S FEES</b>The Parties agree that this Agreement will be governed by the laws of the
            ...
            reasonable attorney’s fees, costs and pre and post judgment interest.<br><b>RULES AND CONTIONS FOR
                USAGE</b><br><b> CANDLES:</b>The use of any type of flame is prohibited in all buildings and throughout the
            site. The new “flameless
            candles” which are battery operated are permitted
            for use.<br> <b>CHILDREN:</b>There have been times we have had guests at the complex whose children were not
            properly supervised.
            ...
            are not permitted near the pond). <br> <b> CONTACT PERSON:</b>You must designate one individual as your Contact
            ...
            photographer, caterer, florist, or musician as your liaison). <br><b> DELIVERIES / DELIVERY TRUCKS:</b>There is
            ...
            we can meet them and show them where to drop their rentals. <br><b> DECORATIONS:</b>Only pushpins and drafting
            ...
            remove all decorations and return Venue to the condition in which it was received. <br> <b> EVENT ENDING
                TIME:</b>All events must end by 11:00 PM to comply with Township/County sound ordinances and to allow for
            clean-up and closure of the site by 1:00 AM.<br><b>GARBAGE DISPOSAL:</b>Trash disposal, other than the garbage
            ...
            agents, and sub-contractors.<br><b>GUESTS:</b>Please keep in mind when inviting Guests to your event, that you
            are inviting them to our home. We will
            expect visitors to conduct themselves in a mature,
            responsible, and respectful manner. <br> <b> HAIR & MAKE-UP</b>The Customer may provide their own Hair and
            ...
            the discretion of The Bond unless prior arrangements have been and approved by The Bond.<br><b>HANDICAP
                ACCOMMODTIONS:</b>We provide level-designated parking, ramped walkways throughout the property along with
            suitable restroom
            facilities. Motorized and transport
            chairs can easily navigate the grounds. All venues on the property are handicapped accessible.<br><b>MUSIC AND
                ENTERTAINMENT: </b>Although music (both live and recorded) is permitted, the music must be
            ...
            <br><b> PARKING:</b>Parking is available at the designated areas on the East side of the complex (gravel and
            ...
            event, applicable parking charges may apply.<br><b> PETS:</b>Sorry, absolutely no pets allowed. However, a
            ...
            <br><b>RENTAL SPACE CHANGES: </b>Any contents or furniture movement must be pre-approved by The Bond. It is
            ...
            <br> <b>SIGNAGE:</b>You may post your group’s sign or hang balloons at the front entrance on Hudson Street,
            ...
            permitted in the designated areas only.<br><b> CATERING:</b> The catering service areas in each of the venues
            are not intended to be used as a kitchen
            for meal preparation.<br><b> WEATHER:</b> The weather is usually suitable for outside events from May 15 until
            October 15. Since
            ...
            heaters, provided they are set-up at an acceptable location.<br><b>WEDDING TENT / ARBOR: </b>The Gazebo and
            ...
            <br><b>WEDDING CEREMONIES:</b> Wedding ceremonies may be held in the Reception Venue for no additional charge.
            Additional fees may apply for reset of room from ceremony to reception. Customer is responsible for
            providing ceremony coordinator, officiate, ceremony music and sound system.<br><b>WEDDING REHEARSAL:</b>In order
            ...
            The Event Coordinator at The Bond 1786.<br><b>LOGISTICAL PLANS: </b>The Bond 1786 planning team must review and
            approve all proposed logistical plans
            for the use of the premises a minimum of thirty (30) days prior to an event.<br><b>EVENTS & WEDDING POLICY AND
    ...
    <div class="main-div">
        ...
        <div class="col-md-6" style="float:right;width:50%">
            ...
            <img src="{{@$sign}}" style="width:40%; border-bottom:1px solid black;margin-top:5px">
        </div>
