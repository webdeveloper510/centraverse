...
<body>
    <!-- <div class="row">
        <div class="col-md-12 "> -->
            <div class="img-section">
                <img class="logo-img" src="{{ Storage::url('uploads/logo/logo-light.png') }}" style="width:40%;"><br>
            <!-- </div>
            <div class="img-section"> -->
    ...
    <!-- <div class="row">
        <div class="col-md-12"> -->
            <p style="font-size:x-small;">This contract defines the terms and conditions under which Lotus Estate, LLC dba The Bond 1786,
                ...
                Bond 1786), and <b>{{$meeting['name']}}</b>(hereafter referred to as the Customer) agree to the
                Customer’s use of The Bond 1786 facilities on <b>{{$startdate}}</b>
    ...
    <div class="row">
        <div class="col-md-12">
           <!-- <b> Venue :</b>  <span>{{$meeting['venue_selection']}}</span>
            ...
            <table class='billing'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >
                            {{$billing_data['food_package']['quantity']}}</td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            {{$billing_data['bar_package']['quantity']}}</td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            {{$billing_data['hotel_rooms']['quantity']}}</td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            {{$billing_data['equipment']['quantity']}}</td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            {{$billing_data['additional_items']['notes']}}</td>
            ...
            <div class="main-div">
                <div class="row">
                    <div class="col-md-6" style="float:left;width:50%;">
                        ...
                        <img src="{{$base64Image}}" style="width:40%; margin-top:5px;border-bottom:1px solid black;">
                    </div>
                </div>
