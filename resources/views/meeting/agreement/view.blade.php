            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$meeting['venue_selection']}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding:5px 5px; margin-left:5px;font-size:13px"></td>
                        <td style="padding:5px 5px; margin-left:5px;font-size:13px;">${{$billing_data['setup']['cost']}}
                        </td>
                        <td style="padding:5px 5px; margin-left:5px;font-size:13px;">
