  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-md-6">
                <a href="#"data-url="{{route('campaign.existinguser')}}" data-size="lg" data-ajax-popup="true" 
                data-bs-toggle="tooltip" data-title="{{__('User List')}}" title="{{__('Select Reciients')}}" 
                class="btn btn-primary btn-icon m-1 close" style="float: right;">{{__('Existing Lead')}}</a>
            </div>
            <div class="col-md-6">
