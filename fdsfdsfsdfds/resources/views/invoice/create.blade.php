...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {!!Form::select('opportunity', $opportunities, null,array('id'=>'opportunity','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('account',__('Account'),['class'=>'form-label']) }}
            {{Form::text('account',null,array('id'=>'account_name','class'=>'form-control','placeholder'=>__('Enter account')))}}
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {!!Form::select('billing_contact', $contact, null,array('class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {!!Form::select('shipping_contact', $contact, null,array('class' => 'form-control')) !!}
        </div>
    </div>
    {{-- <div class="col-6">
        <div class="form-group">
